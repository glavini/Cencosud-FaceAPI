...
bf.faceapi.test = {
    ...
    start: function () {
        ...
        $('#VideoPlayerContainer').on('click', bf.faceapi.test.takeSnapshot);
        $('#ButtonSwitchWebcam').on('click', bf.faceapi.test.switchWebcam);
    ...
    switchWebcam: function () {
        bf.faceapi.core.stopWebcam(bf.faceapi.test.video);

        bf.faceapi.core.initWebcam('VideoPlayer', (bf.faceapi.test.video ? !bf.faceapi.test.video.rear : true), function (video) {
            bf.faceapi.test.video = video;
        }, bf.faceapi.test.takeSnapshotHandleError);
    },
    ...
    setPhotoReady: function () {
        ...
        setTimeout(bf.faceapi.test.analyze, 200);
    },
