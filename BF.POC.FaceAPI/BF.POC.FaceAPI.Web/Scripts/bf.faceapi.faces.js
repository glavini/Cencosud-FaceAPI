...
bf.faceapi.faces = {
    ...
    startAdd: function () {
        ...
        $('#VideoPlayerContainer').on('click', bf.faceapi.faces.takeSnapshot);
        $('#ButtonSwitchWebcam').on('click', bf.faceapi.faces.switchWebcam);
    ...
    switchWebcam: function () {
        bf.faceapi.core.stopWebcam(bf.faceapi.faces.video);

        bf.faceapi.core.initWebcam('VideoPlayer', (bf.faceapi.faces.video ? !bf.faceapi.faces.video.rear : true), function (video) {
            bf.faceapi.faces.video = video;
        }, bf.faceapi.faces.takeSnapshotHandleError);
    },
