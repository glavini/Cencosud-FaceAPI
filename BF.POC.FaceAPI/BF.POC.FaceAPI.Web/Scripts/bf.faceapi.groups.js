...
bf.faceapi.groups = {
    ...
    startSearch: function () {
        ...
        $('#VideoPlayerContainer').on('click', bf.faceapi.groups.takeSnapshot);
        $('#ButtonSwitchWebcam').on('click', bf.faceapi.groups.switchWebcam);
    ...
    initVideo: function () {
        bf.faceapi.core.initWebcam('VideoPlayer', true, function (video) {
    ...
    switchWebcam: function () {
        bf.faceapi.core.stopWebcam(bf.faceapi.groups.video);

        bf.faceapi.core.initWebcam('VideoPlayer', (bf.faceapi.groups.video ? !bf.faceapi.test.groups.rear : true), function (video) {
            bf.faceapi.groups.video = video;
        }, bf.faceapi.groups.takeSnapshotHandleError);
    },
    ...
    setPhotoReady: function () {
        ...
        setTimeout(bf.faceapi.groups.search, 200);
    },
